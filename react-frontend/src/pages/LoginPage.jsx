...
const LoginPage = () => {
  return (
    /* Dimensions set to 120px width and 200px height with overflow enabled */
    <div className="LoginPage w-[120px] h-[200px] overflow-auto mx-auto mt-10">
      <div className="bg-card border border-card-line rounded-xl shadow-2xs">
        <div className="p-4 sm:p-7">
          ...
          <div className="mt-5">
            <a
              className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg bg-layer border border-layer-line text-layer-foreground shadow-2xs hover:bg-layer-hover disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-layer-focus"
              href="#"
            >
              <svg
            ...
            <form>
              <div className="grid gap-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <label
                    htmlFor="checkbox"
                    className="ms-3 text-sm text-foreground"
                  >
                    Remember me
                  </label>
                </div>
