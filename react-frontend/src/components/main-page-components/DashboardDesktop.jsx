    ...
    <div className="desktop-display flex gap-5">
      <section className="income-cards_grid">
        <div className="income-card flex_center">
          ...
          <h3 className="income-card_title bold_font h3_style black-text">$8,500.00</h3>
          <progress
            max="100"
            value="80"
        ...
        <div className="income-card flex_center">
          ...
          <h3 className="income-card_title bold_font h3_style black-text">$4,200.00</h3>
          <progress
            max="100"
            value="40"
        ...
        <div className="income-card flex_center">
          ...
          <h3 className="income-card_title bold_font h3_style black-text">$4,300.00</h3>
          <progress
            max="100"
            value="60"
            className="income-card_prog-bar progress-bar-green"
